...
export const CARD_DB = {
  ...
  aendor:          { id: 'aendor',          name: 'Aendor, The Ancient', type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.ANGEL], attribute: 'light',   rules: 'Aura 1: Enemy combat units within 1 tile have -1 ATK in combat.', aura: { range: 1, stat: 'atk', value: -1, target: 'enemy' }, legendary: true, image: 'aendor.webp' },
  ...
  sapling:         { id: 'sapling',         name: 'Sapling',             type: 'unit',  cost: 0, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.PLANT], attribute: 'mystic',  rules: 'When this unit is destroyed, restore 1 HP to your champion.', token: true, image: 'sapling-token.webp' },

  // Elf spells
  moonleaf:        { id: 'moonleaf',        name: 'Moonleaf',            type: 'spell', cost: 2, effect: 'moonleaf',        unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Increase the HP of a friendly combat unit by the number of cards in your hand.', image: 'moonleaf.webp' },
  ...
  scorched_earth:  { id: 'scorched_earth',  name: 'Scorched Earth',  type: 'terrain', isTerrain: true, cost: 2, terrainRadius: 0, unitType: [], attribute: 'primal', rules: 'Any unit that moves onto this tile takes 1 damage.', terrainEffect: { id: 'scorched', onOccupy: { damage: 1 } }, image: 'scorchedearth.webp' },
