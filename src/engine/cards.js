...
export const CARD_DB = {
  ...
  captain:         { id: 'captain', rarity: 'common',         name: 'Captain',             type: 'unit',  cost: 5, atk: 4, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Aura 1: Friendly units within 1 tile have +1 ATK.', aura: { range: 1, stat: 'atk', value: 1, target: 'friendly' }, image: 'captain.webp' },
  ...
  shimmerguardian: { id: 'shimmerguardian', rarity: 'common', name: 'Shimmer Guardian',      type: 'unit',  cost: 5, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.SPIRIT], attribute: 'light',   rules: 'When this unit takes damage, return it to your hand.', triggers: [{ event: 'onDamageTaken', effect: 'returnToHand', selfTrigger: true }], image: 'shimmerguardian.webp' },
  ...
  oathkeepparagon:  { id: 'oathkeepparagon', rarity: 'common',  name: 'Oathkeep Paragon',    type: 'unit',  cost: 5, atk: 4, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: '+1 HP for each other friendly unit you control.', modifier: { type: 'conditionalStatBuff', stat: 'hp', scaling: 'friendlyUnitCount' }, image: 'oathkeepparagon.webp' },
  ...
  stormcrestdrake:  { id: 'stormcrestdrake', rarity: 'common',  name: 'Stormcrest Drake',   type: 'unit',  cost: 7, atk: 6, hp: 6, spd: 2, unitType: [UNIT_TYPES.DRAGON],  attribute: 'mystic',  rules: 'Flying', flying: true, image: 'stormcrestdrake.webp' },
  lifebinder:       { id: 'lifebinder', rarity: 'common',       name: 'Lifebinder',          type: 'unit',  cost: 6, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.ELF, UNIT_TYPES.GIANT], attribute: 'mystic',  rules: 'When summoned, return target friendly unit to full health.', image: 'lifebinder.webp' },
  ...
  spellkeeper:      { id: 'spellkeeper', rarity: 'common',      name: 'Spellkeeper',         type: 'unit',  cost: 2, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.ELF], attribute: 'mystic',  rules: 'After you cast a spell this turn, return that card to your hand.', triggers: [{ event: 'onCardPlayed', effect: 'spellkeeperReturn', selfTrigger: false }] },
  dryadtrickster:   { id: 'dryadtrickster', rarity: 'common',   name: 'Dryad Trickster',     type: 'unit',  cost: 2, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.ELF], attribute: 'mystic',  hidden: true, rules: "Hidden. On reveal: switch the ATK and HP of the unit that revealed this. If not in battle, choose the target." },
  veilseer:         { id: 'veilseer', rarity: 'common',         name: 'Veil Seer',           type: 'unit',  cost: 2, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.ELF], attribute: 'mystic',  rules: "When summoned, look at the opponent's hand." },
  ...
  veilfiend:       { id: 'veilfiend', rarity: 'common',       name: 'Veil Fiend',          type: 'unit',  cost: 4, atk: 3, hp: 2, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'Hidden|On reveal: deal 2 damage to all adjacent enemy units.', hidden: true, image: 'veilfiend.webp' },
  ...
  gravecaller:     { id: 'gravecaller', rarity: 'common',     name: 'Gravecaller',         type: 'unit',  cost: 5, atk: 4, hp: 4, spd: 1, unitType: [UNIT_TYPES.WRAITH], attribute: 'dark',    rules: 'Hidden|On reveal: return a random unit from your Grave to your hand.', hidden: true, image: 'gravecaller.webp' },
  ...
  inkdrinker:      { id: 'inkdrinker', rarity: 'common',      name: 'Ink Drinker',         type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.DEMON],  attribute: 'dark',    rules: 'Whenever you discard a card, draw a card.', triggers: [{ event: 'onCardDiscarded', effect: 'drawOneCard', selfTrigger: false }], image: 'inkdrinker.webp' },
  ...
  hollowoffering:   { id: 'hollowoffering', rarity: 'common',   name: 'Hollow Offering',     type: 'unit',  cost: 1, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'When this unit is destroyed, your champion gains +2 HP.', triggers: [{ event: 'onFriendlyUnitDeath', effect: 'hollowofferingRestore', selfTrigger: true }] },
  ...
  immortal_bastion:    { id: 'immortal_bastion',    rarity: 'rare', name: 'Immortal Bastion',    type: 'relic', cost: 4, atk: 0, hp: 5, spd: 0, isRelic: true, unitType: [], attribute: 'light', adventureOnly: true, rules: "As long as you control this relic, damage that would reduce a friendly unit's HP below 1 reduces it to 1 instead.", modifier: [{ type: 'immortalBastion' }], image: null },
