...
export const CARD_DB = {
  ...
  gore:            { id: 'gore',            name: 'Gore',                type: 'spell', cost: 2, effect: 'gore',            unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Deal 2 damage to a target enemy unit, relic, or omen.', image: 'gore.webp' },
  ...
  dustwall:         { id: 'dustwall',         name: 'Dustwall',          type: 'unit',  cost: 1, atk: 0, hp: 3, spd: 1, unitType: [UNIT_TYPES.CONSTRUCT], attribute: 'neutral', rules: '', image: 'dustwall.webp' },
