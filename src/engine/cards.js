...
export const CARD_DB = {
  ...
  ironshield:      { id: 'ironshield',      name: 'Iron Shield',         type: 'spell', cost: 2, effect: 'ironshield',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Give a friendly unit or relic a shield absorbing up to 5 damage from the next attack.', image: 'ironshield.webp' },
  ...
  // Beast spells
  ambush:          { id: 'ambush',          name: 'Ambush',              type: 'spell', cost: 3, effect: 'ambush',          unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'A friendly unit or relic battles an adjacent enemy unit.', image: 'ambush.webp' },
  ...
  gore:            { id: 'gore',            name: 'Gore',                type: 'spell', cost: 2, effect: 'gore',            unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Deal 2 damage to an enemy unit.', image: 'gore.webp' },
  ...
  sistersiofra:    { id: 'sistersiofra',    name: 'Sister Siofra, First Prayer', type: 'unit', cost: 5, atk: 3, hp: 4, spd: 1, unitType: [UNIT_TYPES.ELF],attribute: 'mystic', rules: 'When a friendly piece is destroyed, your champion gains +2 HP.', legendary: true, image: 'sistersiofra.webp' },
  ...
  bloom:           { id: 'bloom',           name: 'Bloom',               type: 'spell', cost: 3, effect: 'bloom',           unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: "Restore 2 HP to a friendly unit. Deal damage to an enemy unit or relic equal to the total HP you've restored this turn.", image: 'bloom.webp' },
  ...
  // Demon spells
  bloodoffering:   { id: 'bloodoffering',   name: 'Blood Offering',      type: 'spell', cost: 2, effect: 'bloodoffering',   unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy a friendly unit or relic. Deal damage equal to its current ATK to any enemy unit or relic.', image: 'bloodoffering.webp' },
  ...
  darksentence:    { id: 'darksentence',    name: 'Dark Sentence',       type: 'spell', cost: 5, effect: 'darksentence',    unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy an enemy unit or relic.', image: 'darksentence.webp' },
  devour:          { id: 'devour',          name: 'Devour',              type: 'spell', cost: 3, effect: 'devour',          unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy an enemy unit or relic with 2 or less HP.', image: 'devour.webp' },
  ...
  souldrain:       { id: 'souldrain',       name: 'Soul Drain',          type: 'spell', cost: 3, effect: 'souldrain',       unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Deal 2 damage to an enemy unit or relic. Restore HP to your champion equal to the damage dealt.', image: 'souldrain.webp' },
