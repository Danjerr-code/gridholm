...
export const CARD_DB = {
  ...
  gildedcage:      { id: 'gildedcage',      name: 'Gilded Cage',         type: 'spell', cost: 4, effect: 'gildedcage',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Target enemy combat unit becomes trapped in a 5 HP Relic. When the Relic is destroyed, return the unit with its current stats.', image: 'gildedcage.webp' },
