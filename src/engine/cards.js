...
export const CARD_DB = {
  ...
  crusade:         { id: 'crusade', rarity: 'common',         name: 'Crusade',             type: 'spell', cost: 4, effect: 'crusade',         unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Give your champion and friendly units +2 ATK this turn.', image: 'crusade.webp' },
  ...
  verdantsurge:    { id: 'verdantsurge', rarity: 'rare',    name: 'Verdant Surge',       type: 'spell', cost: 5, effect: 'verdantsurge',    unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Skip your champion\'s action this turn. Friendly units within 2 tiles of your champion gain +2/+2 this turn.', image: 'verdantsurge.webp' },
  ...
  pestilence:      { id: 'pestilence', rarity: 'rare',      name: 'Pestilence',          type: 'spell', cost: 3, effect: 'pestilence',      unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: "Skip your champion's action this turn. Enemy units within 2 tiles of your champion have -2/-2 this turn.", image: 'pestilence.webp' },
  ...
  bloodaltar:  { id: 'bloodaltar', rarity: 'rare',  name: 'Blood Altar',       type: 'relic', cost: 2, atk: 0, hp: 1, spd: 0, isRelic: true, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',  rules: 'Action: sacrifice an adjacent friendly unit. Draw 1 card.', action: true, draftStrong: true, image: 'bloodaltar.webp' },
  ...
  negationcrystal:  { id: 'negationcrystal', rarity: 'rare',  name: 'Negation Crystal',  type: 'relic', cost: 2, atk: 0, hp: 1, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', adventureOnly: true, rules: 'When an enemy unit uses its Action ability, automatically destroy this Relic to cancel that ability.', triggers: [{ event: 'onEnemyAction', effect: 'negationcrystal_cancel' }], image: 'negationcrystal.webp' },
  ...
  tanglerootypew:   { id: 'tanglerootypew', rarity: 'rare',   name: 'Tangleroot Yew',    type: 'relic', cost: 2, atk: 0, hp: 3, spd: 0, isRelic: true, unitType: [UNIT_TYPES.ELF], attribute: 'mystic', rules: 'Action -HP: Adjacent enemy units become Rooted.', action: true, image: 'tanglerootyew.webp' },
  ...
  coldsteeldrifter: { id: 'coldsteeldrifter', rarity: 'common', name: 'Coldsteel Drifter', type: 'unit',  cost: 2, atk: 2, hp: 1, spd: 2, unitType: [UNIT_TYPES.CONSTRUCT], attribute: 'neutral', rules: null, image: 'coldsteeldrifter.webp' },
  ...
  mindseize:    { id: 'mindseize', rarity: 'rare',    name: 'Mind Seize',     type: 'spell', cost: 7, effect: 'mindseize',    unitType: [UNIT_TYPES.ELF], attribute: 'mystic', rules: 'Gain control of target enemy unit adjacent to your champion.', image: 'mindseize.webp' },
  ...
  hallowed_ground: { id: 'hallowed_ground', rarity: 'common', name: 'Hallowed Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'light',  rules: 'Light units in this area gain +1/+1. Dark units in this area have -1/-1.', terrainEffect: { id: 'hallowed', rarity: 'common', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'light', opposingAttribute: 'dark', combatOnly: true } }, image: 'hallowedground.webp' },
  ...
  enchanted_ground:{ id: 'enchanted_ground', rarity: 'common',name: 'Enchanted Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'mystic', rules: 'Mystic units in this area gain +1/+1. Primal units in this area have -1/-1.', terrainEffect: { id: 'enchanted', rarity: 'common', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'mystic', opposingAttribute: 'primal', combatOnly: true } }, image: 'enchantedground.webp' },
  cursed_ground:   { id: 'cursed_ground', rarity: 'common',   name: 'Cursed Ground',   type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'dark',   rules: 'Dark units in this area gain +1/+1. Light units in this area have -1/-1.', terrainEffect: { id: 'cursed', rarity: 'common', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'dark', opposingAttribute: 'light', combatOnly: true } }, image: 'cursedground.webp' },
  huntingground:   { id: 'huntingground', rarity: 'common',   name: 'Hunting Ground',  type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'primal',  rules: 'Primal units in this area gain +1/+1. Mystic units in this area have -1/-1.', terrainEffect: { id: 'huntingground', rarity: 'common', name: 'Hunting Ground', description: 'Primal units in this area gain +1/+1. Mystic units in this area have -1/-1.', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'primal', opposingAttribute: 'mystic', combatOnly: true } }, image: 'huntingground.webp' },
