...
export const CARD_DB = {
  ...
  nighthoofreaver: { id: 'nighthoofreaver', name: 'Nighthoof Reaver',     type: 'unit',  cost: 3, atk: 2, hp: 1, spd: 1, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: 'Gain +1/+1 whenever an enemy unit dies.', triggers: [{ event: 'onEnemyUnitDeath', effect: 'gainPlusOnePlusOne', selfTrigger: false }], image: 'nighthoofreaver.webp' },
  ...
  siegeclawwarchief:  { id: 'siegeclawwarchief',  name: 'Siegeclaw Warchief',  type: 'unit', cost: 3, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.BEAST],  attribute: 'primal',  rules: 'Friendly combat units within 2 tiles of the enemy champion have +1 SPD.', modifier: [{ type: 'zoneSpdBuff', anchor: 'enemyChampion', range: 2, amount: 1 }], image: 'siegeclawwarchief.webp' },
  ...
  vornthundercaller: { id: 'vornthundercaller', name: 'Vorn, Thundercaller', type: 'unit', cost: 4, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.BEAST],     attribute: 'primal',  rules: 'Action: Choose a direction. Deal 2 damage to every unit and champion in a straight line.', action: true, legendary: true, image: 'vornthundercaller.webp' },
  azulonsilvertide:  { id: 'azulonsilvertide',  name: 'Azulon, Silver Tide', type: 'unit', cost: 7, atk: 5, hp: 6, spd: 2, unitType: [UNIT_TYPES.ELF],       attribute: 'mystic',  rules: 'Action: The next spell you cast this turn casts twice.', action: true, legendary: true, image: 'azulonsilvertide.webp' },
  ...
  vexishollowking:   { id: 'vexishollowking',   name: 'Vexis, the Hollow King', type: 'unit', cost: 7, atk: 3, hp: 4, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',  rules: 'The first time an enemy combat unit dies each turn, summon a 1/1 shadow copy in an adjacent tile.', legendary: true, triggers: [{ event: 'onEnemyUnitDeath', effect: 'summonShadowCopy', oncePerTurn: true }], image: 'vexishollowking.webp' },
