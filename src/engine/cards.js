...
export const CARD_DB = {
  ...
  aendor:          { id: 'aendor',          name: 'Aendor, The Ancient', type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.ANGEL], attribute: 'light',   rules: 'Flying|Aura 1: Enemy combat units within 1 tile have -1 ATK.', flying: true, aura: { range: 1, stat: 'atk', value: -1, target: 'enemy' }, legendary: true, image: 'aendor.webp' },
  ...
  oathkeepparagon:  { id: 'oathkeepparagon',  name: 'Oathkeep Paragon',    type: 'unit',  cost: 5, atk: 4, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: '+1 HP for each other friendly combat unit you control.', modifier: { type: 'conditionalStatBuff', stat: 'hp', scaling: 'friendlyUnitCount' }, image: 'oathkeepparagon.webp' },
  wardlightcolossus:{ id: 'wardlightcolossus', name: 'Wardlight Colossus',  type: 'unit',  cost: 7, atk: 6, hp: 7, spd: 1, unitType: [UNIT_TYPES.ANGEL], attribute: 'light',   rules: 'Aura 2: Friendly combat units within 2 tiles cannot be targeted by spells.', modifier: [{ type: 'auraSpellImmunity', range: 2 }], image: 'wardlightcolossus.webp' },
  peacekeeper:      { id: 'peacekeeper',       name: 'Peacekeeper',         type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'When summoned, adjacent enemy combat units are stunned next turn.', image: 'peacekeeper.webp' },
  ...
  ironshield:      { id: 'ironshield',      name: 'Iron Shield',         type: 'spell', cost: 2, effect: 'ironshield',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Give a friendly combat unit a shield absorbing up to 5 damage from the next attack.', image: 'ironshield.webp' },
  ...
  martiallaw:      { id: 'martiallaw',      name: 'Martial Law',         type: 'spell', cost: 4, effect: 'martiallaw',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Enemy combat units within 2 tiles of your champion are stunned next turn.', image: 'martiallaw.webp' },
  ...
  standfirm:       { id: 'standfirm',       name: 'Stand Firm',          type: 'spell', cost: 1, effect: 'standfirm',       unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Target friendly combat unit has +2 HP this turn.', image: 'standfirm.webp' },
  gildedcage:      { id: 'gildedcage',      name: 'Gilded Cage',         type: 'spell', cost: 4, effect: 'gildedcage',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Target enemy combat unit becomes trapped in a 5 HP Relic.', image: 'gildedcage.webp' },
  angelicblessing: { id: 'angelicblessing', name: 'Angelic Blessing',    type: 'spell', cost: 6, effect: 'angelicblessing', unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: "Target friendly combat unit adjacent to your champion gains +4/+4 and 'Cannot be targeted by spells'.", image: 'angelicblessing.webp' },
  seconddawn:      { id: 'seconddawn',      name: 'Second Dawn',         type: 'spell', cost: 8, effect: 'seconddawn',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Return all friendly combat units from your grave to tiles adjacent to your champion.', image: 'seconddawn.webp' },
  chainsoflight:   { id: 'chainsoflight',   name: 'Chains of Light',     type: 'omen',  cost: 5, atk: 0, spd: 0, turnsRemaining: 4, isOmen: true, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Target enemy combat unit is Stunned.', image: 'chainsoflight.webp' },
  ...
  packrunt:        { id: 'packrunt',        name: 'Pack Runt',           type: 'unit',  cost: 4, atk: 2, hp: 2, spd: 2, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: 'Has +1 ATK for each other friendly Primal combat unit in play.', image: 'packrunt.webp' },
  ...
  wildborne:       { id: 'wildborne',       name: 'Wildborne',           type: 'unit',  cost: 2, atk: 1, hp: 1, spd: 2, unitType: [UNIT_TYPES.HUMAN], attribute: 'primal',  rules: 'Aura 1: Friendly combat units within 1 tile gain +1/+1.', aura: { range: 1, stat: 'atk', value: 1, target: 'friendly' }, image: 'wildborne.webp' },
  ...
  pounce:          { id: 'pounce',          name: 'Pounce',              type: 'spell', cost: 2, effect: 'pounce',          unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Reset the action of a friendly Primal combat unit.', image: 'pounce.webp' },
  ...
  savagegrowth:    { id: 'savagegrowth',    name: 'Savage Growth',       type: 'spell', cost: 3, effect: 'savagegrowth',    unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Give a friendly combat unit +2/+2 permanently.', image: 'savagegrowth.webp' },
  ...
  lifebinder:       { id: 'lifebinder',       name: 'Lifebinder',          type: 'unit',  cost: 6, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.ELF, UNIT_TYPES.GIANT], attribute: 'mystic',  rules: 'When summoned, return target friendly combat unit to full health.', image: 'lifebinder.webp' },
  rootsongcommander:{ id: 'rootsongcommander',name: 'Rootsong Commander',  type: 'unit',  cost: 5, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.ELF],     attribute: 'mystic',  rules: 'Action: Target friendly combat unit gains +1/+1 for each friendly Elf you control until end of turn.', action: true, image: 'rootsongcommander.webp' },
  ...
  gravecaller:     { id: 'gravecaller',     name: 'Gravecaller',         type: 'unit',  cost: 5, atk: 4, hp: 4, spd: 1, unitType: [UNIT_TYPES.WRAITH], attribute: 'dark',    rules: 'Hidden|On reveal: return a random combat unit from your Grave to your hand.', hidden: true, image: 'gravecaller.webp' },
  gravefedhorror:  { id: 'gravefedhorror',  name: 'Gravefed Horror',     type: 'unit',  cost: 5, atk: 3, hp: 3, spd: 1, unitType: [UNIT_TYPES.SHADOW], attribute: 'dark',    rules: 'Hidden|On reveal: gain +1/+1 for each combat unit in your grave.', hidden: true, image: 'gravefedhorror.webp' },
  ...
  infernalpact:    { id: 'infernalpact',    name: 'Infernal Pact',       type: 'spell', cost: 3, effect: 'infernalpact',    unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Deal 3 damage to your champion. All friendly combat units gain +2 ATK this turn.', image: 'infernalpact.webp' },
  ...
  pestilence:      { id: 'pestilence',      name: 'Pestilence',          type: 'spell', cost: 3, effect: 'pestilence',      unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Enemy combat units within 2 tiles of your champion have -2/-2 this turn.', image: 'pestilence.webp' },
  ...
  wardrum:          { id: 'wardrum',          name: 'War Drum',          type: 'relic', cost: 3, atk: 0, hp: 3, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: 'At the start of your turn, the friendly combat unit with the lowest ATK gains +1 ATK this turn. Random if tied.', image: 'wardrum.webp' },
  ...
  tanglerootypew:   { id: 'tanglerootypew',   name: 'Tangleroot Yew',    type: 'relic', cost: 2, atk: 0, hp: 3, spd: 0, isRelic: true, unitType: [UNIT_TYPES.ELF], attribute: 'mystic', rules: 'Action: Adjacent enemy combat units become Rooted.', action: true, image: 'tanglerootyew.webp' },
  ...
  battlestandard: { id: 'battlestandard', name: 'Battle Standard', type: 'omen', cost: 2, atk: 0, spd: 0, turnsRemaining: 3, isOmen: true, unitType: [], attribute: 'light',   rules: 'Friendly combat units summoned adjacent to this omen gain +1/+1 permanently.', image: 'battlestandard.webp' },
  ...
  hallowed_ground: { id: 'hallowed_ground', name: 'Hallowed Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'light',  rules: 'Light combat units within this terrain area have +1/+1.', terrainEffect: { id: 'hallowed', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'light', combatOnly: true } }, image: 'hallowedground.webp' },
  ...
  enchanted_ground:{ id: 'enchanted_ground',name: 'Enchanted Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'mystic', rules: 'Mystic combat units within this terrain area have +1/+1.', terrainEffect: { id: 'enchanted', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'mystic', combatOnly: true } }, image: 'enchantedground.webp' },
  cursed_ground:   { id: 'cursed_ground',   name: 'Cursed Ground',   type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'dark',   rules: 'Dark combat units within this terrain area have +1/+1.', terrainEffect: { id: 'cursed', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'dark', combatOnly: true } }, image: 'cursedground.webp' },
  huntingground:   { id: 'huntingground',   name: 'Hunting Ground',  type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'primal',  rules: 'Primal combat units within this terrain area have +1/+1.', terrainEffect: { id: 'huntingground', name: 'Hunting Ground', description: 'Primal combat units within this terrain area have +1/+1.', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'primal', combatOnly: true } }, image: 'huntingground.webp' },
};
