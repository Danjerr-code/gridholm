...
export const CARD_DB = {
  ...
  curseflayer:     { id: 'curseflayer',     name: 'Curse Flayer',        type: 'unit',  cost: 2, atk: 2, hp: 1, spd: 1, unitType: [UNIT_TYPES.DEMON],  attribute: 'dark',    rules: 'Hidden.|On reveal: the tile this unit is revealed on becomes Cursed Ground.', hidden: true, image: null },
  gravecaller:     { id: 'gravecaller',     name: 'Gravecaller',         type: 'unit',  cost: 5, atk: 4, hp: 4, spd: 1, unitType: [UNIT_TYPES.WRAITH], attribute: 'dark',    rules: 'Hidden.|On reveal: return a random combat unit from your Grave to your hand.', hidden: true, image: null },
