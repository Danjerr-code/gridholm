...
export const CARD_DB = {
  ...
  footsoldier:     { id: 'footsoldier',     name: 'Cutthroat',           type: 'unit',  cost: 1, atk: 2, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: '', image: 'footsoldier.webp' },
  ...
  sergeant:        { id: 'sergeant',        name: 'Sergeant',            type: 'unit',  cost: 3, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.HUMAN, UNIT_TYPES.SOLDIER], attribute: 'light',   rules: 'Action: The next unit you play this turn gains +1/+1.', action: true, image: 'sergeant.webp' },
  ...
  standardbearer:  { id: 'standardbearer',  name: 'Standard Bearer',     type: 'unit',  cost: 3, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Aura 2: Friendly units within 2 tiles have +1/+1.', aura: { range: 2, stat: 'both', value: 1, target: 'friendly' }, image: 'standardbearer.webp' },
  sentinel:        { id: 'sentinel',        name: 'Sentinel',            type: 'unit',  cost: 3, atk: 1, hp: 3, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Aura 1: Restore 1 HP to friendly units within 1 tile at end of turn.', aura: { range: 1, stat: 'hp', value: 1, target: 'friendly', trigger: 'endturn', excludeSelf: true }, image: 'sentinel.webp' },
  ...
  captain:         { id: 'captain',         name: 'Captain',             type: 'unit',  cost: 5, atk: 4, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Aura 1: Friendly units within 1 tile have +1 ATK.', aura: { range: 1, stat: 'atk', value: 1, target: 'friendly' }, image: 'captain.webp' },
  aendor:          { id: 'aendor',          name: 'Aendor, The Ancient', type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.ANGEL], attribute: 'light',   rules: 'Flying|Aura 1: Enemy units within 1 tile have -1 ATK.', flying: true, aura: { range: 1, stat: 'atk', value: -1, target: 'enemy' }, legendary: true, image: 'aendor.webp' },
  ...
  shimmerguardian: { id: 'shimmerguardian', name: 'Shimmer Guardian',      type: 'unit',  cost: 5, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.SPIRIT], attribute: 'light',   rules: 'When this unit takes damage, return it to your hand.', triggers: [{ event: 'onDamageTaken', effect: 'returnToHand', selfTrigger: true }], image: 'shimmerguardian.webp' },
  veilbreaker:     { id: 'veilbreaker',     name: 'Veilbreaker',           type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN, UNIT_TYPES.KNIGHT], attribute: 'light',   rules: 'When this unit attacks a Hidden unit, destroy that unit. The Hidden reveal is not activated.', image: 'veilbreaker.webp' },
  oathkeepparagon:  { id: 'oathkeepparagon',  name: 'Oathkeep Paragon',    type: 'unit',  cost: 5, atk: 4, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: '+1 HP for each other friendly unit you control.', modifier: { type: 'conditionalStatBuff', stat: 'hp', scaling: 'friendlyUnitCount' }, image: 'oathkeepparagon.webp' },
  wardlightcolossus:{ id: 'wardlightcolossus', name: 'Wardlight Colossus',  type: 'unit',  cost: 7, atk: 6, hp: 7, spd: 1, unitType: [UNIT_TYPES.ANGEL], attribute: 'light',   rules: 'Aura 2: Friendly units within 2 tiles cannot be targeted by spells.', modifier: [{ type: 'auraSpellImmunity', range: 2 }], image: 'wardlightcolossus.webp' },
  peacekeeper:      { id: 'peacekeeper',       name: 'Peacekeeper',         type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'When summoned, adjacent enemy units are stunned next turn.', image: 'peacekeeper.webp' },

  // Human spells
  smite:           { id: 'smite',           name: 'Smite',               type: 'spell', cost: 3, effect: 'smite',           unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Deal 4 damage to one enemy unit or relic within 2 tiles of your champion.', image: 'smite.webp' },
  ironshield:      { id: 'ironshield',      name: 'Iron Shield',         type: 'spell', cost: 2, effect: 'ironshield',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Give a friendly unit a shield absorbing up to 5 damage from the next attack.', image: 'ironshield.webp' },
  ...
  forgeweapon:     { id: 'forgeweapon',     name: 'Forge Weapon',        type: 'spell', cost: 2, effect: 'forgeweapon',     unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Give a friendly unit +2 ATK permanently.', image: 'forgeweapon.webp' },
  fortify:         { id: 'fortify',         name: 'Fortify',             type: 'spell', cost: 3, effect: 'fortify',         unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'All friendly units gain +2 HP until end of turn.', image: 'fortify.webp' },
  rally:           { id: 'rally',           name: 'Rally',               type: 'spell', cost: 3, effect: 'rally',           unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'All friendly units gain +1 ATK until end of turn.', image: 'rally.webp' },
  crusade:         { id: 'crusade',         name: 'Crusade',             type: 'spell', cost: 5, effect: 'crusade',         unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'All friendly units gain +2 ATK until end of turn.', image: 'crusade.webp' },
  martiallaw:      { id: 'martiallaw',      name: 'Martial Law',         type: 'spell', cost: 4, effect: 'martiallaw',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Enemy units within 2 tiles of your champion are stunned next turn.', image: 'martiallaw.webp' },
  rebirth:         { id: 'rebirth',         name: 'Rebirth',             type: 'spell', cost: 4, effect: 'rebirth',         unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: "Skip your champion's action this turn. Return a friendly unit from your grave to an adjacent tile.", image: 'rebirth.webp' },
  standfirm:       { id: 'standfirm',       name: 'Stand Firm',          type: 'spell', cost: 1, effect: 'standfirm',       unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Target friendly unit has +2 HP this turn.', image: 'standfirm.webp' },
  gildedcage:      { id: 'gildedcage',      name: 'Gilded Cage',         type: 'spell', cost: 4, effect: 'gildedcage',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Target enemy unit becomes trapped in a 5 HP Relic.', image: 'gildedcage.webp' },
  angelicblessing: { id: 'angelicblessing', name: 'Angelic Blessing',    type: 'spell', cost: 6, effect: 'angelicblessing', unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: "Target friendly unit adjacent to your champion gains +4/+4 and 'Cannot be targeted by spells'.", image: 'angelicblessing.webp' },
  seconddawn:      { id: 'seconddawn',      name: 'Second Dawn',         type: 'spell', cost: 8, effect: 'seconddawn',      unitType: [UNIT_TYPES.HUMAN],attribute: 'light',   rules: 'Return all friendly units from your grave to tiles adjacent to your champion.', image: 'seconddawn.webp' },
  chainsoflight:   { id: 'chainsoflight',   name: 'Chains of Light',     type: 'omen',  cost: 5, atk: 0, spd: 0, turnsRemaining: 4, isOmen: true, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Target enemy unit is Stunned.', image: 'chainsoflight.webp' },
  ...
  packrunner:      { id: 'packrunner',      name: 'Pack Runner',         type: 'unit',  cost: 3, atk: 1, hp: 3, spd: 1, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: 'Action: Reset the action of a different friendly unit or relic.', action: true, image: 'packrunner.webp' },
  packrunt:        { id: 'packrunt',        name: 'Pack Runt',           type: 'unit',  cost: 4, atk: 2, hp: 2, spd: 2, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: 'Has +1 ATK for each other friendly unit in play.', image: 'packrunt.webp' },
  ...
  razorfang:       { id: 'razorfang',       name: 'Razorfang, Alpha',    type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 2, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: "Rush|When this unit destroys an enemy unit or relic, reset this unit's action. Once per turn.", rush: true, legendary: true, image: 'razorfang.webp' },
  tuskling:        { id: 'tuskling',        name: 'Tuskling',            type: 'unit',  cost: 2, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.BEAST], attribute: 'primal',  rules: 'Rush', rush: true, image: 'tuskling.webp' },
  unrulythundertusk: { id: 'unrulythundertusk', name: 'Unruly Thundertusk', type: 'unit', cost: 5, atk: 7, hp: 4, spd: 1, unitType: [UNIT_TYPES.BEAST], attribute: 'primal', rules: "This unit's actions cost 2 commands.", doubleCommandCost: true, image: 'unrulythundertusk.webp' },
  wildborne:       { id: 'wildborne',       name: 'Wildborne',           type: 'unit',  cost: 2, atk: 1, hp: 1, spd: 2, unitType: [UNIT_TYPES.HUMAN], attribute: 'primal',  rules: 'Aura 1: Friendly units within 1 tile gain +1/+1.', aura: { range: 1, stat: 'atk', value: 1, target: 'friendly' }, image: 'wildborne.webp' },
  ...
  // Beast spells
  ambush:          { id: 'ambush',          name: 'Ambush',              type: 'spell', cost: 3, effect: 'ambush',          unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'A friendly unit battles an adjacent enemy unit.', image: 'ambush.webp' },
  packhowl:        { id: 'packhowl',        name: 'Pack Howl',           type: 'spell', cost: 3, effect: 'packhowl',        unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'All friendly Primal units gain +1 ATK and +1 SPD this turn.', image: 'packhowl.webp' },
  ...
  crushingblow:    { id: 'crushingblow',    name: 'Crushing Blow',       type: 'spell', cost: 4, effect: 'crushingblow',    unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: "Skip your champion's action this turn. Deal 4 damage to an adjacent unit and push it back 1 tile.", image: 'crushingblow.webp' },
  animus:          { id: 'animus',          name: 'Animus',              type: 'spell', cost: 1, effect: 'animus',          unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Target friendly unit gains +2 ATK this turn.', image: 'animus.webp' },
  gore:            { id: 'gore',            name: 'Gore',                type: 'spell', cost: 2, effect: 'gore',            unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Deal 2 damage to target piece.', image: 'gore.webp' },
  ...
  apexrampage:     { id: 'apexrampage',     name: 'Apex Rampage',        type: 'spell', cost: 7, effect: 'apexrampage',     unitType: [UNIT_TYPES.BEAST],attribute: 'primal',  rules: 'Target friendly unit gains +2 ATK and 2 extra actions this turn.', image: 'apexrampage.webp' },

  // Elf units
  elfscout:        { id: 'elfscout',        name: 'Sylvan Scout',        type: 'unit',  cost: 1, atk: 1, hp: 2, spd: 2, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: '', image: 'elfscout.webp' },
  ...
  woodlandguard:   { id: 'woodlandguard',   name: 'Woodland Guard',      type: 'unit',  cost: 2, atk: 1, hp: 3, spd: 1, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: 'Action: Deal 1 damage to an enemy unit or relic within 2 tiles.', action: true, image: 'woodlandguard.webp' },
  whisper:         { id: 'whisper',         name: 'Whisper',             type: 'unit',  cost: 2, atk: 1, hp: 4, spd: 1, unitType: [UNIT_TYPES.ELF, UNIT_TYPES.SPIRIT],   attribute: 'mystic',  rules: 'When this unit attacks, restore 1 HP to your champion.', image: 'whisper.webp' },
  ...
  elfelder:        { id: 'elfelder',        name: 'Mystic Elder',        type: 'unit',  cost: 3, atk: 2, hp: 4, spd: 1, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: 'When summoned, restore 2 HP to your champion.', image: 'elfelder.webp' },
  thornweave:      { id: 'thornweave',      name: 'Thornweaver',         type: 'unit',  cost: 3, atk: 2, hp: 3, spd: 1, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: 'When this unit is destroyed, restore 3 HP to your champion.', image: 'thorneweave.webp' },
  elfranger:       { id: 'elfranger',       name: 'Sylvan Ranger',       type: 'unit',  cost: 4, atk: 3, hp: 4, spd: 2, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: '', image: 'elfranger.webp' },
  grovewarden:     { id: 'grovewarden',     name: 'Grove Warden',        type: 'unit',  cost: 4, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: 'Action: Restore 1 HP to your champion for each friendly Mystic unit you control.', action: true, image: 'grovewarden.webp' },
  ...
  elfarcher:       { id: 'elfarcher',       name: 'Highborne Archer',    type: 'unit',  cost: 5, atk: 2, hp: 5, spd: 1, unitType: [UNIT_TYPES.ELF],   attribute: 'mystic',  rules: 'Action: Deal 2 damage to a unit within 2 tiles.', action: true, image: 'elfarcher.webp' },
  sistersiofra:    { id: 'sistersiofra',    name: 'Sister Siofra, First Prayer', type: 'unit', cost: 5, atk: 3, hp: 4, spd: 1, unitType: [UNIT_TYPES.ELF],attribute: 'mystic', rules: 'When a friendly unit is destroyed, your champion gains +2 HP.', legendary: true, image: 'sistersiofra.webp' },
  ...
  canopysentinel:   { id: 'canopysentinel',   name: 'Canopy Sentinel',    type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 1, unitType: [UNIT_TYPES.PLANT],   attribute: 'mystic',  rules: 'When summoned, summon a Sapling in an adjacent tile.', image: 'canopysentinel.webp' },
  cascadesage:      { id: 'cascadesage',      name: 'Cascade Sage',       type: 'unit',  cost: 6, atk: 4, hp: 4, spd: 1, unitType: [UNIT_TYPES.WIZARD],   attribute: 'mystic',  rules: 'The first time you cast a spell each turn, draw a card.', triggers: [{ event: 'onCardPlayed', effect: 'drawOnFirstSpell', oncePerTurn: true }], image: 'cascadesage.webp' },
  stormcrestdrake:  { id: 'stormcrestdrake',  name: 'Stormcrest Drake',   type: 'unit',  cost: 7, atk: 6, hp: 6, spd: 2, unitType: [UNIT_TYPES.DRAGON],  attribute: 'mystic',  rules: 'Flying', flying: true, image: 'stormcrestdrake.webp' },
  lifebinder:       { id: 'lifebinder',       name: 'Lifebinder',          type: 'unit',  cost: 6, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.ELF, UNIT_TYPES.GIANT], attribute: 'mystic',  rules: 'When summoned, return target friendly unit to full health.', image: 'lifebinder.webp' },
  rootsongcommander:{ id: 'rootsongcommander',name: 'Rootsong Commander',  type: 'unit',  cost: 5, atk: 2, hp: 2, spd: 1, unitType: [UNIT_TYPES.ELF],     attribute: 'mystic',  rules: 'Action: Target friendly unit gains +1/+1 for each friendly Elf you control until end of turn.', action: true, image: 'rootsongcommander.webp' },

  // Elf spells
  moonleaf:        { id: 'moonleaf',        name: 'Moonleaf',            type: 'spell', cost: 2, effect: 'moonleaf',        unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Increase the HP of a friendly unit equal to the number of cards in your hand.', image: 'moonleaf.webp' },
  ...
  bloom:           { id: 'bloom',           name: 'Bloom',               type: 'spell', cost: 3, effect: 'bloom',           unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: "Restore 2 HP to a friendly unit. Deal damage to an enemy unit equal to the total HP you've restored this turn.", image: 'bloom.webp' },
  entangle:        { id: 'entangle',        name: 'Entangle',            type: 'spell', cost: 3, effect: 'entangle',        unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Choose a friendly Mystic unit. Enemy units adjacent to that unit cannot move next turn.', image: 'entangle.webp' },
  ...
  petrify:         { id: 'petrify',         name: 'Petrify',             type: 'spell', cost: 4, effect: 'petrify',         unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Transform target enemy unit with 4 or less HP into a Relic with no abilities.', image: 'petrify.webp' },
  glitteringgift:  { id: 'glitteringgift',  name: 'Glittering Gift',     type: 'spell', cost: 2, effect: 'glitteringgift',  unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: "Give a friendly unit +1/+1 and 'When this unit is destroyed, draw a card.'", image: 'glitteringgift.webp' },
  recall:          { id: 'recall',          name: 'Recall',              type: 'spell', cost: 2, effect: 'recall',          unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: "Return target unit to its owner's hand.", image: 'recall.webp' },
  amethystcache:   { id: 'amethystcache',   name: 'Amethyst Cache',      type: 'spell', cost: 5, effect: 'amethystcache',   unitType: [UNIT_TYPES.ELF],  attribute: 'mystic',  rules: 'Create an Amethyst Crystal in a tile adjacent to your champion.', image: 'amythstcache.webp' },
  amethystcrystal: { id: 'amethystcrystal', name: 'Amethyst Crystal',    type: 'relic', cost: 0, atk: 0, hp: 5, spd: 0, isRelic: true, unitType: [], attribute: 'mystic',  rules: 'When this relic is destroyed, draw 3 cards.', triggers: [{ event: 'onFriendlyUnitDeath', effect: 'drawThreeCards', selfTrigger: true }], token: true, image: 'ameythystcrystal-relic.webp' },

  // Demon units
  spiteling:       { id: 'spiteling',       name: 'Spiteling',           type: 'unit',  cost: 1, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'When this unit dies, deal 1 damage to a random enemy unit.', triggers: [{ event: 'onFriendlyUnitDeath', effect: 'deathPing', selfTrigger: true }], image: 'spiteling.webp' },
  ...
  brutedemon:      { id: 'brutedemon',      name: 'Infernal Spider',     type: 'unit',  cost: 3, atk: 5, hp: 1, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: '', image: 'brutedemon.webp' },
  ...
  fleshtithe:      { id: 'fleshtithe',      name: 'Flesh Tithe',         type: 'unit',  cost: 4, atk: 3, hp: 3, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'When summoned, you may sacrifice a friendly unit. If you do, this unit gains +2/+2.', image: 'fleshtithe.webp' },
  ...
  curseflayer:     { id: 'curseflayer',     name: 'Curse Flayer',        type: 'unit',  cost: 2, atk: 2, hp: 1, spd: 1, unitType: [UNIT_TYPES.DEMON],  attribute: 'dark',    rules: 'Hidden|On reveal: the tile this unit is revealed on becomes Cursed Ground.', hidden: true, image: 'curseflayer.webp' },
  gravecaller:     { id: 'gravecaller',     name: 'Gravecaller',         type: 'unit',  cost: 5, atk: 4, hp: 4, spd: 1, unitType: [UNIT_TYPES.WRAITH], attribute: 'dark',    rules: 'Hidden|On reveal: return a random unit from your Grave to your hand.', hidden: true, image: 'gravecaller.webp' },
  gravefedhorror:  { id: 'gravefedhorror',  name: 'Gravefed Horror',     type: 'unit',  cost: 5, atk: 3, hp: 3, spd: 1, unitType: [UNIT_TYPES.SHADOW], attribute: 'dark',    rules: 'Hidden|On reveal: gain +1/+1 for each unit in your grave.', hidden: true, image: 'gravefedhorror.webp' },
  inkdrinker:      { id: 'inkdrinker',      name: 'Ink Drinker',         type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.DEMON],  attribute: 'dark',    rules: 'Whenever you discard a card, draw a card.', triggers: [{ event: 'onCardDiscarded', effect: 'drawOneCard', selfTrigger: false }], image: 'inkdrinker.webp' },
  zmore:           { id: 'zmore',           name: 'Zmore, Sleeping Ash', type: 'unit',  cost: 6, atk: 4, hp: 6, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'At the end of your turn, deal 1 damage to all other units.', legendary: true, image: 'zmore.webp' },
  ...
  gorethirstfiend: { id: 'gorethirstfiend', name: 'Gorethirst Fiend',     type: 'unit',  cost: 3, atk: 2, hp: 3, spd: 1, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',    rules: 'Whenever you deal damage to the enemy champion, deal 2 damage to a random enemy unit.', triggers: [{ event: 'onChampionDamageDealt', effect: 'dealTwoToRandomEnemyUnit', preventRetrigger: true }], image: 'gorethirstfiend.webp' },
  ...
  vanguardtaskmaster: { id: 'vanguardtaskmaster', name: 'Vanguard Taskmaster', type: 'unit', cost: 3, atk: 1, hp: 1, spd: 1, unitType: [UNIT_TYPES.HUMAN],  attribute: 'light',   rules: 'Whenever another friendly unit uses a command, it gains +1 HP.', triggers: [{ event: 'onFriendlyCommand', effect: 'gainPlusOneHPOnCommand' }], image: 'vanguardtaskmaster.webp' },
  ...
  spitechanneler:    { id: 'spitechanneler',    name: 'Spite Channeler',    type: 'unit', cost: 4, atk: 3, hp: 3, spd: 1, unitType: [UNIT_TYPES.WIZARD],   attribute: 'mystic', rules: 'Whenever you deal non-combat damage to the enemy champion, deal 1 additional damage.', triggers: [{ event: 'onNonCombatChampionDamage', effect: 'plusOneNonCombatChampionDamage', preventRetrigger: true }], image: 'spitechanneler.webp' },
  ...
  lucernunbrokenvow: { id: 'lucernunbrokenvow', name: 'Lucern, Unbroken Vow',    type: 'unit', cost: 5, atk: 3, hp: 3, spd: 2, unitType: [UNIT_TYPES.SPIRIT], attribute: 'light', rules: 'When this unit dies on the Throne tile, resummon it at the end of your turn in your champion\'s starting tile. Retains all permanent stat changes.', legendary: true, image: 'lucern.webp' },

  // Batch 8: Legendaries Part 4
  nezzartermsandconditions: { id: 'nezzartermsandconditions', name: 'Nezzar, Terms and Conditions', type: 'unit', cost: 4, atk: 1, hp: 3, spd: 0, unitType: [UNIT_TYPES.DEMON], attribute: 'dark', rules: 'At the beginning of your turn, choose a deadly contract.', legendary: true, image: 'nezzar.webp' },

  // Batch 7: Legendaries Part 3
  korraksecondang:   { id: 'korraksecondang',   name: 'Korrak, Second Fang',   type: 'unit', cost: 5, atk: 3, hp: 2, spd: 1, unitType: [UNIT_TYPES.BEASTKIN], attribute: 'primal', rules: 'While your champion is within 2 tiles, your champion has +3 ATK and +1 SPD.', legendary: true, modifier: [{ type: 'championAtkBuff', range: 2, amount: 3 }, { type: 'championSpdBuff', range: 2, amount: 1 }], image: 'korrak.webp' },
  fennwickthequiet:  { id: 'fennwickthequiet',  name: 'Fennwick, the Quiet',   type: 'unit', cost: 2, atk: 1, hp: 2, spd: 1, unitType: [UNIT_TYPES.HUMAN, UNIT_TYPES.WIZARD],   attribute: 'mystic', rules: 'Your spells cost 1 less, minimum 1. Action: Look at the top card of your deck.', legendary: true, action: true, modifier: [{ type: 'spellCostReduction', amount: 1 }], image: 'fennwick.webp' },
  gavrielholystride: { id: 'gavrielholystride', name: 'Gavriel, Holy Stride',  type: 'unit', cost: 4, atk: 3, hp: 4, spd: 1, unitType: [UNIT_TYPES.HUMAN, UNIT_TYPES.PALADIN], attribute: 'light',  rules: 'Cannot be targeted by spells. |When this unit moves into a tile, that tile becomes Hallowed Ground.', legendary: true, spellImmune: true, image: 'gavriel.webp' },
  ...
  tollofshadows:   { id: 'tollofshadows',   name: 'Toll of Shadows',     type: 'spell', cost: 6, effect: 'tollofshadows',   unitType: [UNIT_TYPES.DEMON], attribute: 'dark', rules: 'Each player sacrifices a unit, an omen, a relic, and discards a card.', image: 'tollofshadows.webp' },

  // Demon spells
  bloodoffering:   { id: 'bloodoffering',   name: 'Blood Offering',      type: 'spell', cost: 2, effect: 'bloodoffering',   unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy a friendly unit. Deal damage equal to its current ATK to any enemy unit.', image: 'bloodoffering.webp' },
  ...
  darksentence:    { id: 'darksentence',    name: 'Dark Sentence',       type: 'spell', cost: 5, effect: 'darksentence',    unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy an enemy unit.', image: 'darksentence.webp' },
  devour:          { id: 'devour',          name: 'Devour',              type: 'spell', cost: 3, effect: 'devour',          unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Destroy an enemy unit with 2 or less HP.', image: 'devour.webp' },
  infernalpact:    { id: 'infernalpact',    name: 'Infernal Pact',       type: 'spell', cost: 3, effect: 'infernalpact',    unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Deal 3 damage to your champion. All friendly units gain +2 ATK this turn.', image: 'infernalpact.webp' },
  shadowveil:      { id: 'shadowveil',      name: 'Shadow Veil',         type: 'spell', cost: 1, effect: 'shadowveil',      unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'The next unit you play this turn is summoned with Hidden', image: 'shadowveil.webp' },
  souldrain:       { id: 'souldrain',       name: 'Soul Drain',          type: 'spell', cost: 3, effect: 'souldrain',       unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Deal 2 damage to an enemy unit. Restore HP to your champion equal to the damage dealt.', image: 'souldrain.webp' },
  agonizingsymphony: { id: 'agonizingsymphony', name: 'Agonizing Symphony', type: 'spell', cost: 3, effect: 'agonizingsymphony', unitType: [UNIT_TYPES.DEMON],attribute: 'dark',  rules: "Skip your champion's action this turn. Your opponent discards 2 cards at random.", image: 'agonizingsymphany.webp' },
  pestilence:      { id: 'pestilence',      name: 'Pestilence',          type: 'spell', cost: 3, effect: 'pestilence',      unitType: [UNIT_TYPES.DEMON],attribute: 'dark',    rules: 'Enemy units within 2 tiles of your champion have -2/-2 this turn.', image: 'pestilence.webp' },
  ...
  soulstone:   { id: 'soulstone',   name: 'Soulstone',         type: 'relic', cost: 4, atk: 0, hp: 5, spd: 0, isRelic: true, unitType: [UNIT_TYPES.HUMAN], attribute: 'light', rules: 'When a friendly unit dies, destroy this Relic and summon that unit in this tile.', image: 'soulstone.webp' },
  bloodaltar:  { id: 'bloodaltar',  name: 'Blood Altar',       type: 'relic', cost: 3, atk: 0, hp: 1, spd: 0, isRelic: true, unitType: [UNIT_TYPES.DEMON], attribute: 'dark',  rules: 'Action: sacrifice an adjacent friendly unit. Draw 1 card.', action: true, image: 'bloodaltar.webp' },
  ...
  wardrum:          { id: 'wardrum',          name: 'War Drum',          type: 'relic', cost: 3, atk: 0, hp: 3, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: 'At the start of your turn, the friendly unit with the lowest ATK gains +1 ATK this turn. Random if tied.', image: 'wardrum.webp' },
  manacannon:       { id: 'manacannon',       name: 'Mana Cannon',       type: 'relic', cost: 2, atk: 0, hp: 2, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: 'Action ⓵: Deal 1 damage to the first unit in the chosen direction, friendly or enemy.', action: true, image: 'manacannon.webp' },
  negationcrystal:  { id: 'negationcrystal',  name: 'Negation Crystal',  type: 'relic', cost: 2, atk: 0, hp: 1, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: 'When an enemy unit uses its Action ability, automatically destroy this Relic to cancel that ability.', triggers: [{ event: 'onEnemyAction', effect: 'negationcrystal_cancel' }], image: 'negationcrystal.webp' },
  arcanelens:       { id: 'arcanelens',       name: 'Arcane Lens',       type: 'relic', cost: 2, atk: 0, hp: 2, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: 'Action: Look at the top 3 cards of your deck. Put one on top and shuffle the rest back.', action: true, image: 'arcanelens.webp' },
  darkirongate:     { id: 'darkirongate',     name: 'Darkiron Gate',     type: 'relic', cost: 3, atk: 0, hp: 6, spd: 0, isRelic: true, unitType: [], attribute: 'neutral', rules: null, image: 'darkirongate.webp' },
  tanglerootypew:   { id: 'tanglerootypew',   name: 'Tangleroot Yew',    type: 'relic', cost: 2, atk: 0, hp: 3, spd: 0, isRelic: true, unitType: [UNIT_TYPES.ELF], attribute: 'mystic', rules: 'Action: Adjacent enemy units become Rooted.', action: true, image: 'tanglerootyew.webp' },
  dustwall:         { id: 'dustwall',         name: 'Dustball',          type: 'unit',  cost: 1, atk: 0, hp: 3, spd: 1, unitType: [UNIT_TYPES.CONSTRUCT], attribute: 'neutral', rules: '', image: 'dustwall.webp' },
  ...
  mindseize:    { id: 'mindseize',    name: 'Mind Seize',     type: 'spell', cost: 7, effect: 'mindseize',    unitType: [UNIT_TYPES.ELF], attribute: 'mystic', rules: "Skip your champion's action. Gain control of target enemy unit adjacent to your champion.", image: 'mindseize.webp' },
  ...
  smokebomb:      { id: 'smokebomb',      name: 'Smoke Bomb',      type: 'omen', cost: 2, atk: 0, spd: 0, turnsRemaining: 2, isOmen: true, unitType: [], attribute: 'dark',    rules: 'Friendly units within 2 tiles become hidden. Any friendly unit summoned within 2 tiles gains Hidden', image: 'smokebomb.webp' },
  ...
  feralsurge:     { id: 'feralsurge',     name: 'Feral Surge',     type: 'omen', cost: 2, atk: 0, spd: 0, turnsRemaining: 3, isOmen: true, unitType: [], attribute: 'primal',  rules: 'Friendly units summoned adjacent to this omen gain Rush', image: 'feralsurge.webp' },
  bloodmoon:      { id: 'bloodmoon',      name: 'Bloodmoon',       type: 'omen', cost: 4, atk: 0, spd: 0, turnsRemaining: 3, isOmen: true, unitType: [], attribute: 'primal',  rules: 'At the beginning of your turn, friendly units gain ATK equal to the number of time counters remaining on this omen.', triggers: [{ event: 'onBeginTurn', effect: 'bloodmoonBuff' }], image: 'bloodmoon.webp' },
  ...
  hallowed_ground: { id: 'hallowed_ground', name: 'Hallowed Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'light',  rules: 'Light units within this terrain area have +1/+1.', terrainEffect: { id: 'hallowed', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'light', combatOnly: true } }, image: 'hallowedground.webp' },
  scorched_earth:  { id: 'scorched_earth',  name: 'Scorched Earth',  type: 'terrain', isTerrain: true, cost: 4, terrainRadius: 2, unitType: [], attribute: 'primal', rules: 'Any unit that moves onto a tile in this terrain area takes 1 damage.', terrainEffect: { id: 'scorched', onOccupy: { damage: 1 } }, image: 'scorchedearth.webp' },
  enchanted_ground:{ id: 'enchanted_ground',name: 'Enchanted Ground', type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'mystic', rules: 'Mystic units within this terrain area have +1/+1.', terrainEffect: { id: 'enchanted', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'mystic', combatOnly: true } }, image: 'enchantedground.webp' },
  cursed_ground:   { id: 'cursed_ground',   name: 'Cursed Ground',   type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'dark',   rules: 'Dark units within this terrain area have +1/+1.', terrainEffect: { id: 'cursed', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'dark', combatOnly: true } }, image: 'cursedground.webp' },
  huntingground:   { id: 'huntingground',   name: 'Hunting Ground',  type: 'terrain', isTerrain: true, cost: 3, terrainRadius: 2, unitType: [], attribute: 'primal',  rules: 'Primal units within this terrain area have +1/+1.', terrainEffect: { id: 'huntingground', name: 'Hunting Ground', description: 'Primal units within this terrain area have +1/+1.', whileOccupied: { atkBuff: 1, hpBuff: 1, attributeOnly: 'primal', combatOnly: true } }, image: 'huntingground.webp' },
};
