...
export const CARD_DB = {
  ...
  agonizingsymphony: { id: 'agonizingsymphony', name: 'Agonizing Symphony', type: 'spell', cost: 3, effect: 'agonizingsymphony', unitType: [UNIT_TYPES.DEMON],attribute: 'dark',  rules: "Skip your champion's action this turn. Your opponent discards 2 cards at random.", image: 'agonizingsymphony.webp' },
