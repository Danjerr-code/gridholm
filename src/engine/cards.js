...
export const CARD_DB = {
  ...
  veilbreaker:     { id: 'veilbreaker',     name: 'Veilbreaker',           type: 'unit',  cost: 6, atk: 5, hp: 5, spd: 1, unitType: [UNIT_TYPES.HUMAN, UNIT_TYPES.KNIGHT], attribute: 'light',   rules: 'When this unit attacks a Hidden unit, destroy that unit. The Hidden reveal is not activated.', image: null },
  ...
  dustwall:         { id: 'dustwall',         name: 'Dustwall',          type: 'unit',  cost: 1, atk: 0, hp: 3, spd: 1, unitType: [UNIT_TYPES.CONSTRUCT], attribute: 'neutral', rules: '', image: null },
