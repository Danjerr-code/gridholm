...
export const CARD_DB = {
  ...
  battlepriestunit:{ id: 'battlepriestunit',name: 'Battle Priest',       type: 'unit',  cost: 4, atk: 2, hp: 2, spd: 1, unitType: 'Human',  rules: 'Action: Deal 2 damage to an enemy unit within 1 tile and restore 2 HP to a friendly unit within 1 tile.', action: true, image: 'battlepriestunit.webp' },
  ...
  packrunt:        { id: 'packrunt',        name: 'Pack Runt',           type: 'unit',  cost: 4, atk: 2, hp: 2, spd: 1, unitType: 'Beast',  rules: 'Has +1/+1 for each other friendly Beast combat unit in play.', image: 'packrunt.webp' },
  ...
  woodlandguard:   { id: 'woodlandguard',   name: 'Woodland Guard',      type: 'unit',  cost: 2, atk: 1, hp: 3, spd: 1, unitType: 'Elf',    rules: 'Action: Deal 2 damage to an enemy combat unit within 2 tiles.', action: true, image: 'woodlandguard.webp' },
  ...
  thornweave:      { id: 'thornweave',      name: 'Thornweave',          type: 'unit',  cost: 3, atk: 2, hp: 3, spd: 1, unitType: 'Elf',    rules: 'When this unit is destroyed restore 3 HP to your champion.', image: 'thornweave.webp' },
  ...
  shadowtrap:      { id: 'shadowtrap',      name: 'Shadow Trap',         type: 'unit',  cost: 3, atk: 1, hp: 1, spd: 1, unitType: 'Demon',  rules: 'Hidden. On reveal: destroy the enemy unit that revealed this unit.', hidden: true, image: 'shadowtrap.webp' },
  ...
  shadowveil:      { id: 'shadowveil',      name: 'Shadow Veil',         type: 'spell', cost: 2, effect: 'shadowveil',      unitType: 'Demon', rules: 'Give a friendly unit Hidden until it moves or attacks.', image: 'shadowveil.webp' },
