...
export const CARD_DB = {
  ...
  wardlightcolossus:{ id: 'wardlightcolossus', name: 'Wardlight Colossus',  type: 'unit',  cost: 7, atk: 6, hp: 7, spd: 1, unitType: [UNIT_TYPES.HUMAN], attribute: 'light',   rules: 'Aura 2: Friendly combat units within 2 tiles cannot be targeted by spells.', modifier: [{ type: 'auraSpellImmunity', range: 2 }], image: 'wardlightcolossus.webp' },
  ...
  lifebinder:       { id: 'lifebinder',       name: 'Lifebinder',          type: 'unit',  cost: 6, atk: 5, hp: 6, spd: 1, unitType: [UNIT_TYPES.ELF],     attribute: 'mystic',  rules: 'When summoned, return target friendly combat unit to full health.', image: 'lifebinder.webp' },
