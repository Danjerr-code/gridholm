...
export const CARD_DB = {
  ...
  stormcrestdrake:  { id: 'stormcrestdrake',  name: 'Stormcrest Drake',   type: 'unit',  cost: 7, atk: 6, hp: 6, spd: 2, unitType: [UNIT_TYPES.DRAGON],  attribute: 'mystic',  rules: '', image: 'stormcrestdrake.webp' },
